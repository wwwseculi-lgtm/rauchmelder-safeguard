...
<div class="floating-contact">
    <a href="mailto:www.secu.li@gmail.com" class="float-email" aria-label="E-Mail senden">
...
def main():
    # Alle HTML-Dateien in Unterverzeichnissen
    patterns = [
        'standorte/**/*.html',
    ]
    ...
    print(f"📊 Ergebnis: {added} hinzugefügt, {skipped} übersprungen")
